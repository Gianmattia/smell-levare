<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   String name = events.get(0).getArtist();
...
#rectangle {
    ...
    <p style="margin-top: 400px; margin-left: 5px;"> <img src="https://www.focusjunior.it/content/uploads/2018/10/Michelangelo-Buonarroti.jpg"

        h1="" style="width: 235px; height: 155px; margin-left: -4px; margin-top: -357px;">
    </p>
    <h2 style=" margin-top: -180px;margin-left: 300px;"> <%=name %><label form="Descrizione artista"></label></h2>
    <h3 style=" margin-top: px;margin-left: 300px;"> <label form="Descrizione artista"></label></h3>
    <form action="&lt;%= request.getContextPath() %&gt;/register" method="post">  <button name="Dona" style="height: 35px; width: 90px; margin-top: -50px; margin-left: 1030px; background-color: #4d4d4d;">Dona</button> </form>
 ...
 <label form="Strada artista" style=" margin-top: px;margin-left: 300px;"></label>
     <label form="Tipo di artista" style=" margin-top: px;margin-left: 50px;"></label>
         <label form="Tipo di artista" style=" margin-top:50 px;margin-left: 50px;"></label>

    <hr  style="margin-top: 100px;"     align=left�� size=”1″ width=”300″ color=”white” noshade>
...
Artista molto affermato nella puglia Borbonica gestiva uno spaccio di minori e prostituzione nei bordelli di tutta la città noto anche con il nome di Scintilla O mast munnezz.
  ...
  <form action="&lt;%= request.getContextPath() %&gt;/register" method="post"  style=" margin-top: -100px;">  <button name="Dona" style="height: 35px; width: 90px; margin-buttom: ; margin-left: 1030px; background-color: #4d4d4d;">Dona</button> </form>
