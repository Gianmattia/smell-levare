...
#rectangle {
  ...
  <form action="&lt;%= request.getContextPath() %&gt;/register" method="post" style=" margin-top: -150px;""><button name="Dona" style="height: 35px; width: 90px; margin-top: -150px; margin-left: 1030px; background-color: #4d4d4d;">Recensisci</button> </form>
  ...
  <li> <h3 style=" margin-top: px;margin-left: 300px;"><ul>
     ...
     <label form="Descrizione artista">-Borioso e arrogante non merita un soldo *</label> </ul><ul><label form="Descrizione artista">-Borioso e arrogante non merita un soldo *</label></ul><ul><label form="Descrizione artista">-Borioso e arrogante non merita un soldo *</label></ul></h3></li>
  <form action="&lt;%= request.getContextPath() %&gt;/register" method="post">  <button name="Dona" style="height: 35px; width: 90px; margin-top: -150px; margin-left: 1030px; background-color: #4d4d4d;">Recensisci</button> </form>
  <form action="&lt;%= request.getContextPath() %&gt;/register" method="post">   <button name="Informazioni" style="height: 35px; width: 90px; margin-top: 20px; margin-left: 480px; background-color: #4d4d4d;">Vedi altre</button></form>
  ...
  <li> <h3 style=" margin-top: px;margin-left: 300px;"><ul>
     ...
     <label form="Descrizione artista">-Borioso e arrogante non merita un soldo *</label> </ul></ul><ul><label form="Descrizione artista">-Borioso e arrogante non merita un soldo *</label></ul></h3></li>
  <form action="&lt;%= request.getContextPath() %&gt;/register" method="post">  <button name="Dona" style="height: 35px; width: 90px; margin-top: -150px; margin-left: 1030px; background-color: #4d4d4d;">Recensisci</button> </form>
  <form action="&lt;%= request.getContextPath() %&gt;/register" method="post">   <button name="Informazioni" style="height: 35px; width: 90px; margin-top: 20px; margin-left: 480px; background-color: #4d4d4d;">Vedi altre</button></form>
