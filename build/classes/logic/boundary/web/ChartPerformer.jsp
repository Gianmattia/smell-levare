...
#rectangle {
   ...
   <li> <h3 style=" margin-top: px;margin-left: 300px;"><ul>
     ...
     <label form="Descrizione artista">-Borioso e arrogante non merita un soldo *</label><label style="margin-top:90px;margin-left:100px;">Gimmy13</label>  </ul><ul><label form="Descrizione artista">-Borioso e arrogante non merita un soldo *</label><label style="margin-top:90px;margin-left:100px;">Valerietto</label></ul><ul><label form="Descrizione artista">-Borioso e arrogante non merita un soldo *</label><label style="margin-top:90px;margin-left:100px;">Giorgiette Magritte</label></ul></h3></li>
